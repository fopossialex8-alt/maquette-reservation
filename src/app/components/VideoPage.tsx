...
import { Play, Clock, Filter, Youtube } from 'lucide-react';
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
          ...
          <div className="bg-white rounded-lg shadow-lg overflow-hidden">
            <div className="grid lg:grid-cols-2 gap-6">
              ...
              <div className="p-6 flex flex-col justify-center">
                ...
                <button className="px-6 py-3 bg-yellow-500 text-slate-950 font-bold rounded-lg hover:bg-yellow-400 transition-colors flex items-center gap-2 w-fit">
        ...
        {selectedVideo !== null && (
          <div className="mt-12 bg-white rounded-lg shadow-sm p-8">
            <h3 className="text-2xl font-bold text-slate-950 mb-6">Commentaires</h3>
            <div className="mb-6">
              <textarea
            ...
            <div className="space-y-4">
              {[
                { author: 'Sophie M.', time: 'Il y a 1 heure', comment: 'Excellente enquête, bravo pour ce travail de fond !' },
                { author: 'Thomas L.', time: 'Il y a 3 heures', comment: 'Très instructif, ce genre de contenu est essentiel.' }
              ].map((comment, index) => (
